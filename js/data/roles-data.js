const roles = [
  ...
  },
  {
    ...
    circleSessionDescription: "**Door de Cirkelzitting anders**\n\nIn de stilte van de nacht fluistert hij woorden die beter vergeten hadden kunnen blijven. Waar anderen afscheid nemen, probeert de Dodenbezweerder het onvermijdelijke terug te draaien.\n\nEénmaal per spel kan hij een ritueel beginnen om een gestorven speler terug tot leven te wekken. Het ritueel start ’s nachts en duurt tot het begin van de volgende nacht. In deze periode mag de Dodenbezweerder door niemand worden bezocht of onderzocht; gebeurt dat wel, dan mislukt het ritueel. Hij mag het later opnieuw proberen zolang het nog niet gelukt is. Tijdens het ritueel mag hij in het Burgerberaad op geen enkele manier aankondigen of hinten wat hij doet.\n\nDit ritueel vraagt echter een offer: wanneer iemand wordt teruggebracht, moet er een leven worden gegeven. Dit kan zijn eigen leven zijn of dat van een andere burger.\n\nKiest de Dodenbezweerder een levende buurman van de dode als offer, dan sterft deze in stilte. Zijn dood wordt niet om 20:00 aangekondigd, maar pas meegenomen in de aankondiging van 09:00. Heeft de dode geen levende buurman, dan is deze stille opoffering niet mogelijk.\n\nDe speler die terugkeert is bovendien niet meer helemaal zoals voorheen. Hij keert half levend terug en kan alleen nog communiceren via emoji-reacties en gebarentaal. Zijn rol en krachten blijven verder zoals ze waren op het moment van zijn dood.",
    isExpansionRole: false,
    expansionKey: null
  },
  {
  ...
  },
  {
    ...
    circleSessionDescription: "**Door de Cirkelzitting anders**\n\nLiefde voor een dag… meer heeft hij niet nodig. Als anderen het maar even voelen.\n\nElke nacht, tussen 20:00 en 22:00, mag de Wingman via een direct bericht aan de GM twee spelers kiezen die op dat moment buren van elkaar zijn in de Cirkelzitting. Eén van deze twee mag hij zelf zijn.\n\nDirect na zijn keuze worden deze twee gekoppeld en komen ze samen in een aparte app. Zij blijven gekoppeld gedurende die nacht en de aansluitende dag. In die tijd delen zij hun lot: sterft één van hen, dan sterft de ander ook.\n\nAan het begin van de volgende nacht dooft de liefde weer uit, en gaan ze ieder hun eigen weg.",
    isExpansionRole: false,
    expansionKey: null
  },
  {
  ...
  },
  {
    ...
    alliance: "Burger",
    origin: "Whatsapperdam",
    types: ["Toevoegend", "Informatie", "Aankondiging"],
  ...
  },
  {
    ...
    description: "Met modder aan zijn laarzen en het land als zijn thuis werkt de Boer rustig door, terwijl het dorp zich druk maakt om wolven en verraad.\n\nDe Boer is een bijrol die bovenop je normale rol wordt uitgedeeld. Iedereen kan een Boer zijn, ongeacht je rol of aard.\n\nAlle Boeren kennen elkaar en kiezen op de eerste dag gezamenlijk en unaniem één Boerenburgemeester. Daarna sluit hun gezamenlijke chat.\n\nEen Boer zijn geeft verder geen extra krachten of spelvoordelen.",
    isExpansionRole: true,
  ...
  },
  {
    ...
    name: "De Wakkerdamse Ridder met het Roestige Zwaard",
  ...
  },
  {
    ...
    name: "De Wakkerdamse Grote Boze Wolf",
  ...
  },
  {
    ...
    description: "Gedreven door overtuiging en een haast ziekelijke drang om het dorp naar zijn hand te zetten, verzamelt de Verschrikkelijke Sektariër langzaam zijn volgelingen. Iedereen heeft een plek in zijn perfecte gemeenschap... of ze dat nu willen of niet.\n\nElke nacht, tussen 20:00 en 09:00, kan de Verschrikkelijke Sektariër via een direct bericht aan de GM een speler overtuigen om toe te treden tot zijn sekte. Deze speler behoudt zijn eigen rol, maar behoort vanaf dat moment ook tot de sekte.\n\nIn plaats daarvan kan de Sektariër een van zijn sekteleden via de GM opdracht geven een speler naar zijn keuze te vermoorden. Het sektelid mag deze opdracht accepteren of weigeren.\n\nAccepteert hij, dan vermoordt hij het slachtoffer en mag hij daarna kiezen om trouw te blijven of de sekte te verlaten. Weigert hij, dan ligt zijn lot volledig in handen van de Verschrikkelijke Sektariër en kan hij de sekte niet meer verlaten.\n\nDe sekte kan uit maximaal 5 leden bestaan. Overdag mag de Verschrikkelijke Sektariër via de GM privéberichten naar zijn sekteleden sturen.\n\nSterft de Verschrikkelijke Sektariër, dan valt zijn sekte uiteen en zijn alle leden weer op zichzelf aangewezen.",
    isExpansionRole: true,
    expansionKey: "back-to-basics-wakkerdam-editie"
  },
  {
    id: "de-toneelspeler-wakkerdam",
    name: "De Wakkerdamse Toneelspeler",
  ...
  },
  {
    ...
    origin: "Wakkerdam",
    types: ["Uitbreiding", "Informatie"],
    description: "Onbekend voor het dorp en voorlopig zelfs onbekend voor het spel. De Zigeunerin wacht geduldig tot haar tijd in Wakkerdam is aangebroken.\n\nSpoedig zal zij haar eigen doel krijgen en haar magische krachten van de Maan gebruiken.\n\nVoor nu blijft haar toekomst echter verborgen en is de Zigeunerin nog niet te vinden in Wakkerdam.",
    isExpansionRole: true,
    expansionKey: "back-to-basics-wakkerdam-editie"
  }
];
